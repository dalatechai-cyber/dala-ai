...
const base: ReceptionInput = {
  ...
  canned: CANNED, tenantGuard: GUARD, cannedLabel: 'БЭЛЭН ХАРИУЛТ', cannedHash: null, fallbackLine: null, noInbox: false, ownSiteHosts: [], complaintRules: [], sales: null, replyStyle: null,
